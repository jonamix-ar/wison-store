"use client";
import { createBrand } from "@/services/products-service";
...
export default function BrandsCreate() {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            toast.error("No se pudo crear la marca. Por favor revise el mensaje de error e inténtelo de nuevo.");
        } finally {
    ...
    return (
        <div className="flex flex-row gap-4 justify-center">
            ...
            >
                ...
                {/* Image Upload */}
                <ImageUpload onImagesChange={setImages} productId={0} initialImages={[]} maxImages={1} />
