...
export default function ProductEdit() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (id) {
          ...
          // Set product type based on attributes
          setValue("productType", productData.attributes.length > 0 ? "variant" : "simple");
        }
      } catch (err) {
  ...
  const toggleSwitch = (
    field: keyof Pick<FormValues, "showPrice" | "showPriceWholeWaller" | "status">
  ) => {
          ...
          <div className="bg-white shadow-sm rounded-lg p-6">
            ...
            <div className="grid gap-6">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="promotionalPrice" className="text-sm font-medium text-gray-700">
                    Precio promocional
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="space-y-2">
                <label htmlFor="priceWholeSaller" className="text-sm font-medium text-gray-700">
                  Precio al por mayor
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="qtyBellowMin" className="text-sm font-medium text-gray-700">
                    Cantidad mínima
                  </label>
                  <input
                    type="number"
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="space-y-4 p-4 bg-gray-50 rounded-md mb-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor={`attributes.${index}.name`} className="block text-sm font-medium text-gray-700">
                      Nombre
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor={`attributes.${index}.value`} className="block text-sm font-medium text-gray-700">
                      Valor
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label htmlFor={`attributes.${index}.qty`} className="block text-sm font-medium text-gray-700">
                      Cantidad
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label htmlFor={`attributes.${index}.price`} className="block text-sm font-medium text-gray-700">
                      Precio
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label htmlFor={`attributes.${index}.priceWholesaler`} className="block text-sm font-medium text-gray-700">
                      Precio mayorista
                    </label>
                    <input
                      type="number"
                ...
                <div>
                  <label htmlFor={`attributes.${index}.qtyBellowMin`} className="block text-sm font-medium text-gray-700">
                    Cantidad mínima
                  </label>
                  <input
                    type="number"
