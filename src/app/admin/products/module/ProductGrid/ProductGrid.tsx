...
const ProductGrid: React.FC<ProductGridProps> = ({ products, list = false }) => {
  ...
  return (
    <div className={`grid gap-4 ${list ? "grid-cols-1" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"}`}>
      {products.map((product) => (
        ...
        >
          ...
          <div className={`${list ? "flex-1" : "text-center"}`}>
            ...
            <div className="mt-4">
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Precio</p>
